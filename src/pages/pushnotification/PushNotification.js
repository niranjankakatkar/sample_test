                  ...
                  <div className="card w-100">
                    <div className="card-body">
                      <div className="grid-info-item inactive-items">
                        <div className="grid-info">
                          <span>Inactive Notifications</span>
                          <h4>{inactiveCount}</h4>
                        </div>
                        <div className="grid-head-icon">
                  ...
                  <div className="card w-100">
                    <div className="card-body">
                      <div className="grid-info-item location-info">
                        <div className="grid-info">
                          <span>Advertise Notifications</span>
                          <h4>0</h4>
                        </div>
                        <div className="grid-head-icon">
            ...
            <div className="modal-content">
              <div className="modal-body">
                <div className="form-header">
                  ...
                  <h3>Are You Sure?</h3>
                  <p>You want delete Notification</p>
                </div>
            ...
            <div className="modal-content">
              <div className="modal-header border-0">
                <div className="form-header modal-header-title text-start mb-0">
                  <h4 className="mb-0">Add New Notification</h4>
                </div>
                <button
                  type="button"
                  className="btn-close"
        ...
        >
          <div className="modal-dialog modal-dialog-centered modal-md">
            <div className="modal-content">
              <div className="modal-header border-0">
                <div className="form-header modal-header-title text-start mb-0">
                  <h4 className="mb-0">Push Notification Details</h4>
                </div>
                <div className="d-flex details-edit-link">
                  <a
                    ...
                    data-bs-target="#edit_companies"
                  >
                    <i className="fe fe-edit me-2"></i>Edit Push Notification
                  </a>
                  <button
                    type="button"
