                                ...
                                <div className="col-xl-5 d-flex">
                                    <div className="dash-user-card w-100">
                                        ...
                                        <div className="dash-img">
                                            <img src="assets/img#top-card-img.png" alt="img"/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="row dash-company-row w-100 m-0">
                                        <div className="col-lg-3 col-sm-6 d-flex">
                                            <div className="company-detail-card w-100">
                                                <div className="company-icon">
                                                    <img src="assets/img/icons/dash-card-icon-01.svg" alt="img"/>
                                                </div>
                                                <div className="dash-comapny-info">
                                                    <h6>Total Users</h6>
                                                    <h5>{userCount} {franchiseeCount}</h5>
                                        ...
                                        <div className="col-lg-3 col-sm-6 d-flex">
                                            <div className="company-detail-card bg-info-light w-100">
                                                <div className="company-icon">
                                                    <img src="assets/img/icons/dash-card-icon-02.svg" alt="img"/>
                                                </div>
                                                <div className="dash-comapny-info">
                                        ...
                                        <div className="col-lg-3 col-sm-6 d-flex">
                                            <div className="company-detail-card bg-pink-light w-100">
                                                <div className="company-icon">
                                                    <img src="assets/img/icons/dash-card-icon-03.svg" alt="img"/>
                                                </div>
                                                <div className="dash-comapny-info">
                                        ...
                                        <div className="col-lg-3 col-sm-6 d-flex">
                                            <div className="company-detail-card bg-success-light w-100">
                                                <div className="company-icon">
                                                    <img src="assets/img/icons/dash-card-icon-04.svg" alt="img"/>
                                                </div>
                                                <div className="dash-comapny-info">
                                                                ...
                                                                <h2 className="table-avatar">
                                                                    <a href="profile.html"
                                                                        ...
                                                                        <img className="avatar-img rounded-circle company"
                                                                            src="assets/img/companies/company-01.svg" alt="img"
                                                                           /></a>
                                                            ...
                                                            <td>
                                                                <h2 className="table-avatar">
                                                                    <a href="profile.html"
                                                                        className="company-avatar avatar-md me-2 companies company-icon">
                                                                        <img className="avatar-img rounded-circle company"
                                                                            src="assets/img/companies/company-02.svg" alt="img"
                                                                           /></a>
                                                            ...
                                                            <td>
                                                                <h2 className="table-avatar">
                                                                    <a href="profile.html"
                                                                        className="company-avatar avatar-md me-2 companies company-icon">
                                                                        <img className="avatar-img rounded-circle company"
                                                                            src="assets/img/companies/company-03.svg" alt="img"
                                                                           /></a>
                                                            ...
                                                            <td>
                                                                <h2 className="table-avatar">
                                                                    <a href="profile.html"
                                                                        className="company-avatar avatar-md me-2 companies company-icon">
                                                                        <img className="avatar-img rounded-circle company"
                                                                            src="assets/img/companies/company-04.svg" alt="img"
                                                                           /></a>
                                                                    <a href="companies.html">Schowalt="img"er Group <span
                                                            ...
                                                            <td>
                                                                <h2 className="table-avatar">
                                                                    <a href="profile.html"
                                                                        className="company-avatar avatar-md me-2 companies company-icon">
                                                                        <img className="avatar-img rounded-circle company"
                                                                            src="assets/img/companies/company-05.svg" alt="img"
                                                                           /></a>
                                                ...
                                                <div className="d-flex align-center">
                                                    ...
                                                    <div className="dropdown main">
                                                        ...
                                                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <li>
                                                                <a href="#top" className="dropdown-item">2023</a>
                                                            </li>
                                                            <li>
                                                                <a href="#top" className="dropdown-item">2022</a>
                                                            </li>
                                                            <li>
                                                                <a href="#top" className="dropdown-item">2021</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="d-flex justify-content-between align-items-center">
                                                ...
                                                <div className="dropdown main">
                                                    ...
                                                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                        <li>
                                                            <a href="#top" className="dropdown-item">Today</a>
                                                        </li>
                                                        <li>
                                                            <a href="#top" className="dropdown-item">This Week</a>
                                                        </li>
                                                        <li>
                                                            <a href="#top" className="dropdown-item">This Year</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div className="dash-plane-list">
                                                <div className="plane-info">
                                                    <span className="icon-plane"><img
                                                        src="assets/img/icons#top-plane-icon.svg" alt="img"/></span>
                                            ...
                                            <div className="d-flex justify-content-between align-items-center">
                                                ...
                                                <div className="dropdown main">
                                                    ...
                                                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                                        <li>
                                                            <a href="#top" className="dropdown-item">This Month</a>
                                                        </li>
                                                        <li>
                                                            <a href="#top" className="dropdown-item">This Week</a>
                                                        </li>
                                ...
                                <div className="col-xl-4 d-flex">
                                    <div className="card super-admin-dash-card flex-fill">
                                        ...
                                        <div className="card-body p-0">
                                            <div className="dash-plane-list">
                                                <div className="plane-info">
                                                    <span className="icon-company"><img src="assets/img/companies/company-04.svg" alt="img"/></span>
                                                    <div className="plane-name"><span>Schowalt="img"er Group</span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h2 className="table-avatar">
                                                                    ...
                                                                    <a href="companies.html">Schowalt="img"er Group</a>
                                                                </h2>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="active-inactive-btn">
                                                                    <a href="#top" className="active-domain"><i
                                                                        className="fe fe-check"></i></a>
                                                                    <a href="#top" className="inactive-domain"><i
