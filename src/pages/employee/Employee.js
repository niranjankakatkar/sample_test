...
export default function User() {
  ...
  useEffect(() => {
    axios
      .get("http://43.205.22.150:5000/employee/getAllEmployee")
      .then((res) => {
        //console.log(res);
        setData(res.data);
      })
  ...
  const handleDelete = (id) => {
    axios
      .delete("http://43.205.22.150:5000/employee/deleteSingleEmployee/" + id)
      .then((res) => {
        //console.log(res);
        navigate("/franchisee");
      })
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("http://43.205.22.150:5000/employee/createEmployee", {
        fname,
        mname,
        lname,
        email,
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="form-field-item">
                        <h5 className="form-title">Employee Profile</h5>
