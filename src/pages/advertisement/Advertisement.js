...
export default function Advertisement() {
  ...
  const handleDelete = () => {
    axios
      .delete("http://localhost:5000/advertisement/deleteSingleAdvertisement/" + ddid)
      .then((res) => {
        console.log(res);
                                        ...
                                        <ul className="dropdown-ul">
                                          <li>
                                            <Link
                                              ...
                                              to={`/advertisement-detail/${user._id}`}
                                            >
        ...
        >
          <div className="modal-dialog modal-dialog-centered modal-md">
            <div className="modal-content">
              <div className="modal-header border-0">
                <div className="form-header modal-header-title text-start mb-0">
                  <h4 className="mb-0">Advertisement Details</h4>
                </div>
                <div className="d-flex details-edit-link">
                  ...
                  >
                    <i className="fe fe-edit me-2"></i>Edit Advertisement
                  </a>
                  <button
                    type="button"
