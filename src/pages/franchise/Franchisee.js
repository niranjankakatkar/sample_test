...
export default function User() {
  ...
  const [activefranchisee, setActivefranchisee] = useState();
  const [inactivefranchisee, setInactivefranchisee] = useState();
  const { post } = "user";
...
useEffect(() => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("http://43.205.22.150:5000/franchisee/createFranchisee", {
        franchisee,
        oname,
        email,
        mobileno,
                  ...
                  <div className="card w-100">
                    <div className="card-body">
                      <div className="grid-info-item active-items">
                        <div className="grid-info">
                          <span>Active Franchisee</span>
                          <h4>{activefranchisee}</h4>
                        </div>
                        <div className="grid-head-icon">
                  ...
                  <div className="card w-100">
                    <div className="card-body">
                      <div className="grid-info-item inactive-items">
                        <div className="grid-info">
                          <span>Inactive Franchisee</span>
                          <h4>{inactivefranchisee}</h4>
                        </div>
                        <div className="grid-head-icon">
                  ...
                  <div className="card w-100">
                    <div className="card-body">
                      <div className="grid-info-item location-info">
                        <div className="grid-info">
                          <span>Franchisee Locations</span>
                          <h4>200</h4>
                        </div>
                        <div className="grid-head-icon">
