            ...
            <div className="modal-content">
              <div className="modal-header border-0">
                <div className="form-header modal-header-title text-start mb-0">
                  <h4 className="mb-0">Add New Cashback</h4>
                </div>
                <button
                  type="button"
                  className="btn-close"
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="form-field-item">
                        <h5 className="form-title">Cashback</h5>
                    ...
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        <label className="form-label">Cashback Title </label>
                        <input
                          type="text"
                    ...
                    <div className="col-md-6">
                      <div className="input-block mb-3">
                        <label className="form-label">Cashback Type</label>
                        <input
                          type="text"
                          className="form-control"
        ...
        >
          <div className="modal-dialog modal-dialog-centered modal-md">
            <div className="modal-content">
              <div className="modal-header border-0">
                <div className="form-header modal-header-title text-start mb-0">
                  <h4 className="mb-0">Cashback Details</h4>
                </div>
                <div className="d-flex details-edit-link">
                  <a
                    ...
                    data-bs-target="#edit_companies"
                  >
                    <i className="fe fe-edit me-2"></i>Edit Cashback
                  </a>
                  <button
                    type="button"
